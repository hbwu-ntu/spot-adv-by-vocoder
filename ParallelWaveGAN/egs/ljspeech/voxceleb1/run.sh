...
conf=conf/parallel_wavegan.v1.long.yaml

# directory path setting
voxceleb_root=/work/jason410/PublicData/Voxceleb1/dev/wav
...
#     echo "Stage -1: Data move"
#     . local/move_data.sh "${voxceleb_root}" "${download_dir}"
# fi
