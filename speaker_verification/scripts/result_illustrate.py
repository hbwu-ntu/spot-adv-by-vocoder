...
if __name__ == "__main__":
    ...
    adv_scores = np.array(np.loadtxt(adv_file, dtype=str).T[3], dtype=np.float)
    adv_vocoder_scores = np.array(np.loadtxt(adv_vocoder_file, dtype=str).T[3], dtype=np.float)
    adv_lin_scores = np.array(np.loadtxt(adv_lin_file, dtype=str).T[3], dtype=np.float)
    adv_mel_scores = np.array(np.loadtxt(adv_mel_file, dtype=str).T[3], dtype=np.float)
    clean_scores = np.array(np.loadtxt(clean_file, dtype=str).T[3], dtype=np.float)
    clean_vocoder_scores = np.array(np.loadtxt(clean_vocoder_file, dtype=str).T[3], dtype=np.float)
    clean_lin_scores = np.array(np.loadtxt(clean_lin_file, dtype=str).T[3], dtype=np.float)
    clean_mel_scores = np.array(np.loadtxt(clean_mel_file, dtype=str).T[3], dtype=np.float)
